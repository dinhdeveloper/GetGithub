...
class ReposDetail : Serializable {
    @SerializedName("id")
    @Expose
    ...
    @Expose
    private var tempCloneToken: Any? = null

    @SerializedName("network_count")
    @Expose
    private var networkCount: Int? = null

    @SerializedName("subscribers_count")
    @Expose
    private var subscribersCount: Int? = null
    ...
    fun getTempCloneToken(): Any? {
        return tempCloneToken
    }

    fun setTempCloneToken(tempCloneToken: Any?) {
    ...
    fun setNetworkCount(networkCount: Int?) {
    ...
    fun setSubscribersCount(subscribersCount: Int?) {
